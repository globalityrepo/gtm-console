...
@Embeddable
public class ResultadoModeloSimuladoCompositeId implements Serializable {
	...
	@Column(name = "N_RESUL_MOD_SMULA", nullable = false)
	private Long ordem;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ResultadoModeloSimuladoCompositeId other = (ResultadoModeloSimuladoCompositeId) obj;
		if (ordem == null) {
			if (other.ordem != null)
				return false;
